export default function PointScreen({ players, pointResult, onNextPoint }) {
  const { pointWinnerIdx, seriesWins, gameName } = pointResult
  return (
    <div className="point-screen">
      ...
      <div className="series-note">{gameName} is best 2 out of 3. First to 2 gives the other player a strike.</div>
